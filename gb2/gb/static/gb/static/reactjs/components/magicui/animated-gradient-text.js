...
const AnimatedGradientText = ({children, className}) => {
  return (
    (<div
      className={cn(
        " group  relative w-full  mx-auto  flex  flex-row    rounded-2xl  bg-white/40  px-4 py-2  text-sm  font-medium  shadow-[inset_0_-8px_10px_#8fdfff1f]  backdrop-blur-sm  transition-shadow  duration-500  ease-out [--bg-size: 300%] hover: shadow-[inset_0_-5px_10px_#8fdfff3f] dark: bg-black/40",
        className
      )}>
      <div
