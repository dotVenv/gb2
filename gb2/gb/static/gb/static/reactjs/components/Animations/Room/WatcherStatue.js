...
Command: npx gltfjsx@6.5.0 ./gb2/gb/static/gb/static/glb/the_watcher.glb 
...
const WatcherStatueModel = ({props}) => {
  ...
  useFrame(() => {
    statueRef.current.rotation.y += Math.PI * 0.005;
...
useGLTF.preload('staticfiles/gb/static/glb/the_watcher.glb')
export default WatcherStatueModel;