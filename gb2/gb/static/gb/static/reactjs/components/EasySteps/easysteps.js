...
import { Card, CardHeader, cn, CardFooter,Code,Spacer } from "@nextui-org/react";
...
const Circle = forwardRef(({ className, children }, ref) => {
    return (
        <div
            ref={ref}
            className={cn(
                "z-10 flex h-12 w-12 items-center justify-center rounded-full border-2 bg-foreground p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
                className
            )}
        >
            {children}
...
const EasySteps = () => {
    ...
    return (
        <>
                ...
                ref={containerRef}
                >
                <div className="flex w-full  bg-transparent flex-row items-stretch justify-between gap-10">
                    ...
                    <div className="flex flex-col justify-center mt-4 pt-4">
                    <Code size='sm' variant='flat'>Wallet</Code>
                    ...
                    <Code size='sm' className='mr-4' variant='flat'>Payout</Code>
                    <Circle ref={div5Ref}>
                        <Icons.payout />
                    </Circle>
                    </div>
                    <div className="flex flex-col justify-center mb-2">
                    <Code size='sm' className='mr-4' variant='flat'>Winner</Code>
                    <Circle ref={div1Ref}>
                        <Icons.champ />
                    </Circle>
                    </div>
