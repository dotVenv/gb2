...
const UserDropdown = ({ userInfo }) => {
    ...
    return(
        ...
        <Dropdown placement="bottom-end" className='text-white bg-zinc-800 items-center rounded-large rounded-border' radius='lg' size='sm'>
        <DropdownTrigger>
            <Avatar
        ...
        <DropdownMenu aria-label="User Dropdown"  className='p-2 mx-auto text-gray-400' radius='lg'  variant="faded">
          ...
          <DropdownItem key="settings" color='primary'><a underline='none'href='/myprofile'>My Profile</a></DropdownItem>
          <DropdownItem key="team_settings" color='primary'><a underline='none'href='/entries'>My Entries ({ userInfo.entries })</a></DropdownItem>
          <DropdownItem key="team_settings" color='primary'><a  underline='none' href='/myteam'>My Team</a></DropdownItem>
